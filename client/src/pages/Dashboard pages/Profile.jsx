...
import Picture from '../../assets/prof.png'
...
const Profile = () => {
  ...
  return (
    <div className='pt-4 pr-10 font-manrope'>
        <div>
            <img className='h-[350px] w-full object-cover rounded-md' src={Background} alt="/" />
        </div>
        <div className='px-8 mt-[-80px] mx-auto container max-w-[800px]'>
            <div className='mb-8'>
                <img  src={Picture} alt="" />
            </div>
            ...
            <form className='flex flex-col gap-4'>
                <div className='flex gap-8'>
                    <div className='flex flex-col w-[50%] '>
                        ...
                        <input className='border-2 h-[40px]' type="text" name="surname" />
                    </div>
                    <div className='flex flex-col w-[50%]'>
                        <label>Last Name</label>
                        <input className='border-2 h-[40px]' type="text" name="last name" />
                    </div>
                    
                </div>
                <div className='flex flex-col'>
                    <label>Email</label>
                    <input className='border-2 h-[40px] ' />
                </div>
                <div className='flex flex-col'>
                    <label>Contact</label>
                    <input className='border-2 h-[40px]' type="tel" />
                </div>
                <div className='flex flex-col'>
                    <label>Address</label>
                    <input className='border-2 h-[40px]' type="text" />
                </div>
                <div className='flex  gap-4 '>
                    ...
                    <div className='flex flex-col w-[50%]'>
                    <label>Country</label>
                    <select className='h-[40px]' id="country" name="country">
